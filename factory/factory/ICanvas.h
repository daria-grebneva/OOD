...
public:
	...
	virtual void DrawEllipse(double left, double top, double width, double height, uint32_t lineColor) = 0;
	virtual void FillEllipse(double left, double top, double width, double height, uint32_t lineColor) = 0;
};
